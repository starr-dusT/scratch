...
:properties:
  :header-args: :tangle ~/devel/elisp/scratch/scratch-emacs/init.el
:end:
** Info 
*** Description 

Configuration for various aspects of file management inside of emacs. 

*** TODOs

insert TODOs here for the associated section of the config.
...
; Prevent quelpa from updating on startup
...
**** TODO Change completions so they use evil-like keybinds for swiper, etc.
...
insert TODOs here for the associated section of the config.
**** DONE update formatting and add video opening in mpv
CLOSED: [2020-09-27 Sun 16:29]
** Dired 
...
Configuration for various programming languages and dev tools. Mostly stolen from the_dev_aspect

*** TODOs

insert TODOs here for the associated section of the config.

**** TODO Clean up Git (and learn it lol)
**** TODO Clean up Projectile
**** TODO Clean up Languages
**** TODO Clean up Productivity
...
Project specific configuration items.

*** TODOs

insert TODOs here for the associated section of the config.

**** TODO Clean up Website Management 
** Website Management
*** tstarr.us 
...
Configuration for applications used within Emacs.

*** TODOs

insert TODOs here for the associated section of the config.

**** TODO Clean up elfeed
**** TODO Clean up mu4e
**** TODO Clean up Term
**** TODO Clean up EMMS
...
; Keybinds
  ;(dw/leader-key-def
  ;  "x"  '(:ignore t :which-key "terms")
  ;  "xt" '(multi-term-next :which-key "multi-term"))
...
Configuration for programs which interact with Linux system utilities.

*** TODOs

insert TODOs here for the associated section of the config.

**** DONE Clean up PulseAudio
CLOSED: [2020-10-27 Tue 21:53]
...
This defines the overall SPC initiated key-chords for general keybinds. Draws heavily from the [[https://github.com/hlissner/doom-emacs][Doom]] keybinds.

*** TODOs

insert TODOs here for the associated section of the config.

**** TODO Clean up general 
**** TODO Clean up open 
